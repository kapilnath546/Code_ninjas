      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="http://localhost:8080/" className="text-gray-700 hover:text-primary transition-colors">Company</a>
            <a href="https://www.chatbase.co/chatbot-iframe/exL1Nfs7bQtdeAMoXCSQF" className="text-gray-700 hover:text-primary transition-colors">Feature</a>
            {session ? (
